...
* [Pipeline Overview](#pipeline_ovrview)
...
## Pipeline_Overview
![Pipeline_Overview](./Figs/Fig2_Extended.png)
...
## Script
### Step 1: Download the raw expression data and calculate the differentially expressed metabolic pathways
...
### Step 2: Extract the metadata from the FPKM and read count files of the severity study ###
...
### Step 3 Model building and single and double gene deletion ###
`mkdir models
...
### Step 4: Drug repurpusing ###
`mkdir drugbank`

## download DrugBank .xml  manually
