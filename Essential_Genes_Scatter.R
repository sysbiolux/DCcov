...
#ng(filename="Figs/DKO_Reduced_list_tripartite_graph_.png", units="in", width=15, height=10, res=300)
#print(p)
#dev.off()
...
"
#convert +append DKO_Reduced_list_tripartite_graph_3colors.png DKO_OneDrug_tripartite_graph_3colors.png  DKO_image_combined.png
